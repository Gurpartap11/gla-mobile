    ...
    private void compute(Calculator.Operator operator) {
        ...
        switch (operator) {
            ...
            case DIV:
                ...
                break;
                /* the case DIV had sub function called instead of div. FIX- called div function
                If the operator is "-" and the sub function is called instead of the div function,
                it will lead to incorrect results. This is because the sub function performs
            ...
            case MUL:
                ...
                /* the case MUL missed a break before default and it will lead to the default result
                even if the condition is correct for MUL. FIX- Break after each case
                when a switch statement is used, it requires a break statement after each case to
                tell the program to stop executing the switch statement.If there is no break
                statement between the case statements, the program will continue executing the
                code in the next case statement, even if it does not meet the condition.
                 */
            default:
